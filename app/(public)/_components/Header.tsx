        ...
        <div className="flex h-16 items-center justify-between md:grid md:grid-cols-[1fr_auto_1fr] w-full">
          ...
          <div className="flex items-center gap-2 md:justify-self-end">
            <div className="hidden sm:flex items-center gap-2">
              ...
              <Link
                href="/register"
                className="h-9 px-3 inline-flex items-center justify-center rounded-md bg-blue-600 text-white text-sm font-semibold hover:opacity-90 transition-opacity"
              >
                Register
              </Link>
            </div>
          ...
          <div className="pb-4 pt-2 border-t border-black/10 dark:border-white/10">
            <div className="flex flex-col gap-2">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <Link
                  href="/register"
                  className="flex-1 h-9 px-3 inline-flex items-center justify-center rounded-md bg-blue-600 text-white text-sm font-semibold hover:opacity-90 transition-opacity"
                >
                  Register
                </Link>
              </div>
